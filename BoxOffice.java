import java.util.Scanner;
     ...
     * The theater is modeled as a 4 by 4 grid with the seats being "Scored" from front row to back. The pricing model is the 
     * opposite of a concert where the closer you are the cheaper you're seat is. This is accurate since the middle and end
     * seats are typically preferred in a movie theater.
     * Users of this program can pick a row and and number of seats per row. Then they are given the option to reserve
     * and purchase them.
     */
public class BoxOffice implements TicketService {
    ...
    /**
     * A seat has a cost ($10-40) assigned to it. This is based on the attractiveness of the seat in the movie theater.
     * A RESERVED seat gets a cost of -1 dollars implying it is unavailable for purchase.
     * A CONFIRMED/PURCHASED seat gets a cost of 0 dollars implying it is gone/sold out.
     */
	 ...
	 * 
	 * A database to store Ticket purchasing info.
	 * A web service to email and confirm with the customer. A http request API to email confirmations and store user confirmations.
	 * A UI Framework in JavaScript or Java FX to make the ticket purchasing easier.
	 * Seating Rows can be labeled, but the price kept the same.
	 * Lastly I would include a timer on the reservations.
	 * 
